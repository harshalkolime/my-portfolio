...
export default function Home() {
  ...
  return (
    <article id='home' className={`${selectedBgColor === "bg-black" ? " bg-[black] text-gray-500" : ""} flex flex-col   justify-between gap-6  h-[100vh] pt-[7rem] pb-20`}>
      ...
      <div data-aos="fade-up" className='w-[100%]  justify-center items-center align-middle flex flex-col gap-2' >
        <h1 className='text-[2rem] font-bold text-white '> Harshal Koli</h1>
        <p className=' w-[20rem] text-sm text-gray-500 text-center'>You are a one click away from building you dream website or web app. Send me the details of your project for a modern, mobile responsive, higly performant webiste today! </p></div>
      <div data-aos="fade-up" data-aos-offset={200} duration={2000} className=' flex justify-center gap-8 h-11'>
